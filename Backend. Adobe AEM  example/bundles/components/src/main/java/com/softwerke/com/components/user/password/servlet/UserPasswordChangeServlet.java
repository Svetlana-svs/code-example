...
import com.package.name.components.user.password.dto.UserPasswordChangeData;
import com.package.name.components.user.password.dto.UserPasswordChangeAuthResult;
