namespace Vast.Wlds
{
    partial class Chart
  {
    ...
    private void InitializeComponent()
    {
        ...
        this.splitContainer.Panel1.Controls.Add(this.m_btnCircle);
        ...
        // m_btnCircle
        // 
        this.m_btnCircle.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Right)));
        this.m_btnCircle.AutoSizeMode = System.Windows.Forms.AutoSizeMode.GrowAndShrink;
        this.m_btnCircle.Location = new System.Drawing.Point(627, 201);
        this.m_btnCircle.Margin = new System.Windows.Forms.Padding(0);
        this.m_btnCircle.Name = "m_btnCircle";
        this.m_btnCircle.Size = new System.Drawing.Size(51, 22);
        this.m_btnCircle.TabIndex = 5;
        this.m_btnCircle.Text = "Цикл";
        this.m_btnCircle.UseVisualStyleBackColor = true;
        this.m_btnCircle.Click += new System.EventHandler(this.m_btnCicle_Click);
        // 
        // pPagination
        // 
        ...
        this.pPagination.Controls.Add(this.m_btnPause);
        this.pPagination.Controls.Add(this.m_btnNext);
        this.pPagination.Controls.Add(this.m_nPage);
        this.pPagination.Location = new System.Drawing.Point(516, 234);
        this.pPagination.Name = "pPagination";
        this.pPagination.Size = new System.Drawing.Size(163, 23);
        ...
        this.m_btnFirst.Click += new System.EventHandler(this.m_btnCircleMeasurement_Click);
        // 
        // m_btnEnd
        // 
        this.m_btnEnd.Location = new System.Drawing.Point(133, 0);
        ...
        this.m_btnEnd.Click += new System.EventHandler(this.m_btnCircleMeasurement_Click);
        // 
        // m_btnPrev
        // 
        ...
        this.m_btnPrev.Click += new System.EventHandler(this.m_btnCircleMeasurement_Click);
        // 
        // m_btnPause
        // 
        this.m_btnPause.Location = new System.Drawing.Point(80, 0);
        this.m_btnPause.Name = "m_btnPause";
        this.m_btnPause.Size = new System.Drawing.Size(30, 23);
        this.m_btnPause.TabIndex = 3;
        this.m_btnPause.Tag = "pause";
        this.m_btnPause.Text = "  |>";
        this.m_btnPause.UseVisualStyleBackColor = true;
        this.m_btnPause.Click += new System.EventHandler(this.m_btnPause_Click);
        // 
        // m_btnNext
        // 
        this.m_btnNext.Location = new System.Drawing.Point(110, 0);
        ...
        this.m_btnNext.Click += new System.EventHandler(this.m_btnCircleMeasurement_Click);
        // 
        // m_nPage
        // 
        this.m_nPage.Location = new System.Drawing.Point(55, 2);
        this.m_nPage.Minimum = new decimal(new int[] {
            1,
            0,
            0,
            0});
        ...
        this.m_nPage.Value = new decimal(new int[] {
            ...
            0,
            0});
        this.m_nPage.Leave += new System.EventHandler(this.m_nPage_Changed);
        this.m_nPage.KeyUp += new System.Windows.Forms.KeyEventHandler(this.m_nPage_KeyUp);
        // 
        // tChart
        // 
        // 
        ...
        this.tChart.MouseClick += new System.Windows.Forms.MouseEventHandler(this.Chart_MouseClick);
        // 
        // timer
        // 
