...
namespace Wlds
{
    public delegate void DelegateDetectorCorrelationCheckedEventHandler(object sender, EventArgs e);
    ...
    public partial class DetectorPanel : UserControl
    {
        ...
        public void SelectCircleMeasurement(int index)
        {
            this.m_cbxDescription.SelectedIndex = index;
        }
