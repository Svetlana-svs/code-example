package com.package.name.components.user.password.servlet;

import com.package.name.components.user.password.dto.UserPasswordResetData;
import com.package.name.components.user.password.dto.UserPasswordChangeResult;
import com.package.name.components.user.registration.exception.VerificationEmailException;
import com.package.name.components.user.registration.service.EmailVerificationService;
import com.package.name.core.analytics.AnalyticsEventController;
import com.package.name.core.config.SiteConfigurationService;
import com.package.name.core.exception.NoSuchBrandException;
import com.package.name.core.exception.ServiceNotConfigured;
import com.package.name.core.service.PromoNodesFinder;
import com.package.name.core.servlet.AbstractServlet;
import com.package.name.core.userdata.UserCredentialsData;
import com.package.name.core.util.RequestUtil;
import com.package.name.core.util.UserUtil;
